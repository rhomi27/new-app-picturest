$('#commtent-btn').click(function(){
    $('#comments-toggle').removeClass('hidden');
    $('#comments-toggle').addClass('flex animate__fadeInUpBig');
    $('#input-comments').addClass('flex animate__fadeInUp');
    $('#input-comments').removeClass('hidden');
    $('#comments-toggle').on('animationend', function(){
        $(this).removeClass('hidden');
    })
})

$('#close-comments').click(function(){
    $('#comments-toggle').addClass('animate__fadeOutDownBig');
    $('#input-comments').addClass('hidden');
    $('#comments-toggle').on('animationend', function(){
