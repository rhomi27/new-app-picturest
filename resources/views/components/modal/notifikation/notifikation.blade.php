<div id="Notification"
    class="z-20 mr-5 hidden w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700"
    aria-labelledby="notifButton">
    <div
    ...
    <div class="divide-y divide-gray-100 dark:divide-gray-700">
        <a href="#" class="flex px-4 py-3 hover:bg-gray-100 dark:hover:bg-gray-700">
            <div class="flex-shrink-0">
                <img class="rounded-full w-11 h-11 object-cover" src="{{ asset('assets/img/imgcreate.jpg') }}"
                    alt="Jese image">
                <div
