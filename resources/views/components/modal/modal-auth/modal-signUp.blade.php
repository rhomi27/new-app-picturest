<div id="sign-up-modal" tabindex="-1" aria-hidden="true"
    class="hidden animate__animated overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white backdrop-blur-sm bg-opacity-90 rounded-xl shadow dark:bg-gray-700">
            ...
            <h1 class="text-xs font-medium text-center">Join and share your work or save your memories here</h1>
            <div class="p-4 md:p-5">
                <form id="signUp-form">
                    <div class="mb-3">
                        <label for="username"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Username</label>
                        <input type="text" name="name" id="usernameUp"
                            class="required max-text bg-blue-50 border border-blue-300 text-gray-900 text-sm rounded-lg block w-full p-2 focus:ring-0"
                            placeholder="Your Username" />
                        <p id="usernameUp-error" class="text-sm text-red-600 pl-2"></p>
                    </div>
                    <div class="mb-3">
                        <label for="emailUp"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                        <input type="text" name="email" id="emailUp"
                            class="required email bg-blue-50 border border-blue-300 text-gray-900 text-sm rounded-lg block w-full p-2 focus:ring-0"
                            placeholder="name@gmail.com" />
                        <p id="emailUp-error" class="text-sm text-red-600 pl-2"></p>
                    </div>
                    <div class="mb-8">
                        <label for="passwordUp"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Password</label>
                        <div class="relative">
                            <input type="password" name="password" id="passwordUp" placeholder="••••••••"
                                class="required min-text bg-blue-50 border border-blue-300 text-gray-900 text-sm rounded-lg block w-full p-2 focus:ring-0" />
                            <button id="show-passwordUp-btn" type="button"
                                class="absolute block bottom-3 right-3 text-gray-600">
                                <svg id="unshow" class="w-4 h-4 hidden" fill="currentColor"
                                ...
                                <svg id="show" class="w-4 h-4" fill="currentColor"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <p id="passwordUp-error" class="text-sm text-red-600 pl-2"></p>
                    </div>
                    <div>
                        <button type="submit" id="submit-signUp-btn" disabled
                            class="w-full flex justify-center items-center text-white hover:text-blue-900 border disabled:cursor-not-allowed border-blue-400 bg-blue-400 hover:bg-transparent font-medium rounded-lg text-sm p-2 text-center transition-all duration-300">
                            <span id="textSignUp">Sign up</span>
                ...
                <div class="text-xs mt-4 font-medium text-gray-500 dark:text-gray-300">
                    ...
                    <button id="signIn-tab" class="text-blue-700 hover:underline">
                        Sign Up
                    </button>
                </div>
            </div>
